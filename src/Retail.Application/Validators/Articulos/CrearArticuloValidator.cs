...
/// <summary>
/// Validador declarativo de reglas de negocio para el alta de nuevos artículos o servicios (RF-04).
/// </summary>
public class CrearArticuloValidator : AbstractValidator<CrearArticuloDto>
{
