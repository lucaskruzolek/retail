...
| **Etapa 1** | **Autenticación, RBAC y Shell de Navegación** | Módulo 1.1 (Pablo) & Módulo 1.2 (Lucas) | 🟡 Módulo 1.2 ✅ | [`docs/roadmap/etapa-1-auth-usuarios.md`](file:///c:/Users/lucas/Proyectos/retail/docs/roadmap/etapa-1-auth-usuarios.md) |
| **Etapa 2** | **Catálogo, Artículos e Importador Masivo** | Módulo 2.1 (Lucas) & Módulo 2.2 (Pablo) | 🟡 Módulo 2.1 ✅ | [`docs/roadmap/etapa-2-catalogo-stock.md`](file:///c:/Users/lucas/Proyectos/retail/docs/roadmap/etapa-2-catalogo-stock.md) |
